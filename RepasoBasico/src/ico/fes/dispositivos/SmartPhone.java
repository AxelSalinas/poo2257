...
public class SmartPhone {
    ...
    public boolean encender(){
        System.out.println("Encediendo el equipo"+ this.marca);
        return true;
    }  
    
    /**
     * EL metodo llamar simula el funcionamiento del programa de telefono
     * smarphone, esto gracias a la posibilidad de la abstracción.
     * 
